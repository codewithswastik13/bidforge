...
export const SEED_USER: UserProfile = {
  ...
  name: "Aarav Mehta",
  handle: "@aarav.bids",
  email: "aarav.m@bidforge.example",
  phone: "+91 ••••• 48210",
...
export function buildSeedPaymentMethods(): PaymentMethod[] {
  return [
    { id: "pm-1", kind: "upi", label: "UPI", detail: "aarav@okbidforge", isDefault: true, verified: true },
